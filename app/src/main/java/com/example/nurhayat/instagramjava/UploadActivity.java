...
public class UploadActivity extends AppCompatActivity {
    ...
    public void chooseImage(View view){
        //İzinleri kontol etme if izin yoksa iste , else izin varsa git galeriden fotografı al
    ...
    public void upload(View view){
        ...
        //adOnSuccesListener : Eger resim alma başarıyl gercekleşmiş ise ne yapacagız
        storageReference.putFile(selected).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) { //Upload başarılı olursa
        ...
        }).addOnFailureListener(new OnFailureListener() { //Bir hata Olursa
            @Override
